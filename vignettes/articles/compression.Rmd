...
* **`cd_values[7]`:** Metadata Value. This serves a dual purpose based on your configuration:
    ...
    * *ZFP Metadata:* If using a ZFP compressor (`cd_values[6]` is 33, 34, or 35), this integer sets the specific lossy parameter based on the chosen mode (e.g., the exact bits of precision to keep).
    * Otherwise, pass `0`.
