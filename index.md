...
- **Portable & Self-Contained:** Builds the HDF5 library from source
  using only standard R build tools. This ensures your package works
...
- **Modern HDF5 Version:** `hdf5lib` bundles HDF5 v2.0.0, providing
...
- **Predictable Versioning and Features:** The version of `hdf5lib`
  ...
  v2.0.0.x bundles HDF5 v2.0.0). This allows developers to require a
...
bundled HDF5 and zlib libraries are available under their own permissive
licenses, as detailed in
[inst/COPYRIGHTS](https://github.com/cmmr/hdf5lib/blob/main/inst/COPYRIGHTS).

*(Note: The zlib library is bundled internally but its headers are not
exposed).*
